"""
Django settings for django_chater_v2 project.
...
ROOT_URLCONF = 'django_chater_v2.urls'
...
WSGI_APPLICATION = 'django_chater_v2.wsgi.application'
ASGI_APPLICATION = 'django_chater_v2.routing.application'
